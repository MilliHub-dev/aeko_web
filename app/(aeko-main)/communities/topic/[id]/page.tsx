...
export default function TopicPage({
	...
	const topic = {
		...
		description:
			"Latest updates on the presidential campaign and debates with comprehensive analysis from political experts and commentators.",
			...
			<div className="border border-border dark:border-border/30 bg-background/95 backdrop-blur-md rounded-2xl overflow-hidden p-6">
				...
				<div className="flex items-center space-x-3">
					...
					<span className="text-sm text-gray-500 dark:text-gray-400">
						+{topic.discussionCount} discussing
						this topic
					</span>
				</div>
			</div>
