...
export default function ExplorePage() {
  ...
  // Trending topics
  const trendingTopics = ["#Pric's baby", "#you.me.us", "#challenge"];
  ...
  return (
    <div className="space-y-5 px-6 mx-auto">
      <div className="sticky top-16 md:top-0 z-10 mb-6 -mx-4 pt-12 px-4  text-black bg-background">
        <div>
          <h1 className="hidden md:block text-3xl font-semibold">Explore</h1>
        </div>
          ...
          >
            <div className="relative">
              ...
              <Input
                ...
                className="w-[calc(100%-32rem)] bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-full pl-15 pr-10 shadow-2xl focus:outline-none focus:ring-2 focus:ring-secondary h-15 placeholder:text-xl"
                value={searchQuery}
