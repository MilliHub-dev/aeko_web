	...
	return (
		<section className="space-y-6">
			<header className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
				<div>
					<h2 className="text-2xl font-semibold text-foreground">Communities to Explore</h2>
				...
				{communities.map((community) => (
					...
					>
						...
						<div className="space-y-4 p-5">
							...
							<Button variant="secondary" size="sm" className="h-9 w-full text-sm font-semibold">
								Follow
							</Button>
						</div>
					</article>
