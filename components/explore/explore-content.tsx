...
import { Post, PostProps } from "../home/post/components/post";
...
export function ExploreContent() {
	...
	return (
		<ScrollArea.Root className="space-y-2 mt-20 md:mt-0 text-black px-8">
			<ScrollArea.Viewport className="h-[calc(100vh-13rem)]">
				{/* Trending Posts Grid */}
				<div className="mb-8">
				...
				<div className="flex justify-center pt-4">
					<Button className="bg-primary text-white">Load More</Button>
				</div>
			</ScrollArea.Viewport>
