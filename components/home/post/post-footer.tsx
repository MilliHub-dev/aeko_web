...
const PostFooter = ({
  ...
  return (
    <motion.div
      className={clsx(
        className,
        "absolute bottom-0 left-0 right-0 z-20 flex flex-col justify-end",
        "px-4 pb-4 pt-20 md:px-8 md:pb-10 md:pt-32 bg-linear-to-t from-slate-950/92 via-slate-950/28 to-transparent"
      )}
      animate={{
